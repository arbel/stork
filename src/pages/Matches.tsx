...
const Matches = () => {
  ...
  // Single source of truth: the context's matches (computed from the DB and refreshed via
  // realtime). The page previously ALSO ran its own duplicate DB fetch that resolved ~1s
  // later and replaced the list mid-view. Alphabetical sort keeps the display stable.
