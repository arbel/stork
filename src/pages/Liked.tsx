      ...
      <div className="p-4">
        {likedNames.length > 0 ? (
          <div className="space-y-6">
            <div className="text-center mb-4">
              <div className="inline-flex items-center space-x-3 space-x-reverse bg-white/90 backdrop-blur-md px-6 py-3 rounded-full shadow-lg">
                ...
                <span className="text-[#22C55E] font-bold text-lg">השמות האהובים עליכם</span>
              </div>
            </div>
          ...
          <div className="text-center py-16">
            ...
            <h3 className="text-2xl font-bold text-white mb-3">עדיין אין מועדפים!</h3>
            <p className="text-white/80 text-lg mb-8 max-w-md mx-auto">החליקו ימינה על שמות שאתם אוהבים.</p>
