...
-- CASCADE removes dependent admin_users policies from earlier migrations; they are recreated below.
DROP FUNCTION IF EXISTS public.is_current_user_admin() CASCADE;
DROP FUNCTION IF EXISTS public.current_user_email_matches(text) CASCADE;
